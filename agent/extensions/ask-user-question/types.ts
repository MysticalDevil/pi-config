...
export const OptionSchema = Type.Object({
  label: Type.String({
    ...
    description: `MAX ${MAX_LABEL_LENGTH} CHARACTERS — hard limit. 1-5 words.`,
  }),
  description: Type.String({ description: "What this choice means or its trade-offs." }),
  preview: Type.Optional(
    Type.String({ description: "Optional markdown shown next to this option when focused." }),
  ),
});
...
export const QuestionSchema = Type.Object({
  ...
  header: Type.String({
    ...
    description: `Max ${MAX_HEADER_LENGTH} chars chip label.`,
  }),
